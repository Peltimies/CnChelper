  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-arcane-950 via-arcane-900 to-arcane-800 px-4">
      <div className="w-full max-w-md">
        ...
        <h2 className="text-xl font-serif font-semibold text-arcane-800 mb-4 text-center">Create Your Account</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <p className="text-center text-sm text-parchment-600 font-body">
            Have an account? <Link to="/login" className="text-arcane-600 hover:underline font-semibold">Login</Link>
          </p>
        </form>
        </div>
      </div>
